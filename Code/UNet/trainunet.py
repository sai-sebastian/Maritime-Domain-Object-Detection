...
from segmentation_models_pytorch import Unet  # Library for segmentation models
import math
...
TRAIN_SPLIT = 0.95
BATCH_SIZE = 2  # Adjusted for larger model
EPOCHS = 50
LR = 1e-4
...
dataset = COCODataset(DATASET_IMAGES, ANNOTATIONS_PATH, transforms=transformations)
...
model = Unet(encoder_name="resnet50", encoder_weights="imagenet", in_channels=3, classes=1)  # Binary segmentation
...
# Step 6: Save Model
torch.save(model.state_dict(),  "C:\\Users\\HP\\Downloads\\fine_tuned_unet.pth")
